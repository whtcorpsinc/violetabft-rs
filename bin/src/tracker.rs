...
pub struct Configuration {
    ...
    /// configuration should be carried out automatically by VioletaBFT when this is
...
impl ProgressTracker {
    ...
    ///
    /// **Note:** Do not use this for majority/quorum calculation. The VioletaBFT node may be
    ...
    /// Records that the node with the given id voted for this VioletaBFT
    ...
    /// Determines if the current quorum is active according to the this violetabft node.
