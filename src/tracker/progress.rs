...
pub struct Progress {
    ...
    /// When Paused is true, violetabft should pause sending replication message to this peer.
    pub paused: bool,
    /// This field is used in ProgressStateSnapshot.
    /// If there is a pending snapshot, the pendingSnapshot will be set to the
    /// index of the snapshot. If pendingSnapshot is set, the replication process of
    /// this Progress will be paused. violetabft will not resend snapshot until the pending one
    ...
    /// Committed index in violetabft_log
