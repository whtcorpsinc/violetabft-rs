...
use crate::evioletabftpb::Message;
...
impl ReadOnly {
    ...
    ///
    /// `index` is the commit index of the violetabft state machine when it received
    ...
    /// Notifies the ReadOnly struct that the violetabft state machine received
